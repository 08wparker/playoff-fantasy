  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-900 to-primary-700">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4">
        ...
        <div className="space-y-4">
          <div className="bg-primary-50 rounded-lg p-4 text-sm text-primary-800">
            ...
            <ul className="space-y-1">
              <li>• Pick your roster each playoff week</li>
              <li>• PPR scoring (1 point per reception)</li>
              <li>• Each player can only be used ONCE</li>
        ...
        <a
          href="https://github.com/08wparker/playoff-fantasy"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 text-xs text-gray-400 hover:text-gray-600 mt-3 transition-colors"
        >
